...
A script used to find all Azure Classic Administrators from all Azure Subscriptions in an Azure Tenant.
...
Get all Classic Administrators for each subscription.

.NOTES

Filename:       Get-all-Azure-Classic-Administrators.ps1
Created:        20/03/2024
...
.\Get-all-Azure-Classic-Administrators.ps1
